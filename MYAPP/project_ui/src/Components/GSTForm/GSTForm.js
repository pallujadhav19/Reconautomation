...
const GSTForm = () => {
    ...
    const validateForm = () => {
        ...
        if (!form.quarter) newErrors.quarter = 'Quarter is required';
        if (!form.month) newErrors.month = 'Month is required';
        if (!form.your_email) newErrors.your_email = 'Your Email is required';
        return newErrors;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            try {
                const response = await fetch(`${config.baseURL.main}${config.api.gst.execute}/`, {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                if (response.ok) {
                    ...
                    setResponseId(result.automationReqIdGST);
                    setShowModal(true);
                } else {
        ...
        <>
            ...
            <div className="container mt-5">
                <Card className="form-container">
                    <Card.Header>Download GSTR 2B</Card.Header>
                    <Card.Body>
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <Form.Group controlId="formQuarter">
                                        <Form.Label className="form-label">Quarter</Form.Label>
                                        <Form.Control
                                            as="select"
                                            name="quarter"
                                            value={form.quarter}
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)}>
                ...
                <Modal.Body>
                    <p>Your GSTR 2B file will be download with request ID : {responseId}</p>
                </Modal.Body>
                <Modal.Footer>
